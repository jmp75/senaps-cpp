...
#ifndef IO_SWAGGER_CLIENT_MODEL_GroupCollection_H_
#define IO_SWAGGER_CLIENT_MODEL_GroupCollection_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<GroupCollection__embedded> getEmbedded() const;
    bool embeddedIsSet() const;
    void unset_embedded();
    void setEmbedded(std::shared_ptr<GroupCollection__embedded> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m__linksIsSet;
    std::shared_ptr<GroupCollection__embedded> m__embedded;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_GroupCollection_H_ */
