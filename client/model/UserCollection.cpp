...
void UserCollection::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("_embedded")))
    {
        ...
        {
            std::shared_ptr<UserCollection__embedded> newItem(new UserCollection__embedded());
...
std::shared_ptr<Organisation__links> UserCollection::getLinks() const
{
    return m__links;
}


void UserCollection::setLinks(std::shared_ptr<Organisation__links> value)
{
    m__links = value;
    m__linksIsSet = true;
}
bool UserCollection::linksIsSet() const
{
    return m__linksIsSet;
}

void UserCollection::unset_links()
{
    m__linksIsSet = false;
}

std::shared_ptr<UserCollection__embedded> UserCollection::getEmbedded() const
{
    return m__embedded;
}


void UserCollection::setEmbedded(std::shared_ptr<UserCollection__embedded> value)
{
    m__embedded = value;
    m__embeddedIsSet = true;
}
bool UserCollection::embeddedIsSet() const
{
    return m__embeddedIsSet;
}

void UserCollection::unset_embedded()
{
    m__embeddedIsSet = false;
}

double UserCollection::getCount() const
{
    return m_Count;
}


void UserCollection::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}
bool UserCollection::countIsSet() const
{
    return m_CountIsSet;
}

void UserCollection::unsetCount()
{
    m_CountIsSet = false;
}
