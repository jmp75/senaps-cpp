...
void PlatformCollection::validate()
{
    // TODO: implement validation
}

web::json::value PlatformCollection::toJson() const
{
...
void PlatformCollection::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("_embedded")))
    {
        ...
        {
            std::shared_ptr<PlatformCollection__embedded> newItem(new PlatformCollection__embedded());
...
void PlatformCollection::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PlatformCollection::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::shared_ptr<Organisation__links> PlatformCollection::getLinks() const
{
    return m__links;
}


void PlatformCollection::setLinks(std::shared_ptr<Organisation__links> value)
{
    m__links = value;
    m__linksIsSet = true;
}
bool PlatformCollection::linksIsSet() const
{
    return m__linksIsSet;
}

void PlatformCollection::unset_links()
{
    m__linksIsSet = false;
}

std::shared_ptr<PlatformCollection__embedded> PlatformCollection::getEmbedded() const
{
    return m__embedded;
}


void PlatformCollection::setEmbedded(std::shared_ptr<PlatformCollection__embedded> value)
{
    m__embedded = value;
    m__embeddedIsSet = true;
}
bool PlatformCollection::embeddedIsSet() const
{
    return m__embeddedIsSet;
}

void PlatformCollection::unset_embedded()
{
    m__embeddedIsSet = false;
}

double PlatformCollection::getCount() const
{
    return m_Count;
}


void PlatformCollection::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}
bool PlatformCollection::countIsSet() const
{
    return m_CountIsSet;
}

void PlatformCollection::unsetCount()
{
    m_CountIsSet = false;
}
