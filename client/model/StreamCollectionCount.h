...
/*
 * StreamCollectionCount.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_StreamCollectionCount_H_
#define IO_SWAGGER_CLIENT_MODEL_StreamCollectionCount_H_
...
/// 
/// </summary>
class  StreamCollectionCount
    : public ModelBase
{
public:
    StreamCollectionCount();
    virtual ~StreamCollectionCount();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_StreamCollectionCount_H_ */
